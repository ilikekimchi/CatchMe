               ...
               <c:if test="${list.size() < 1}">
				...
				<c:forEach var="item" items="${list}">
                  <tr>
                     ...
                     <td class="nth-1">
                    	<fmt:formatNumber pattern="#,###" value="${item.paySaleprice}" />원
                     </td>
                     <td>
                     ${item.payCoin}코인 | [카카오페이] 결제완료
                     </td>
                     <td>
                     	<a href="${item.paySeq}/delete">삭제</a>
                     </td>
                  </tr>
                 </c:forEach>
               </tbody>
               ...
               <tbody>
                  <c:forEach var="coinList" items="${coinList}">
                     <tr>
                        ...
                        <td class="nth-1"><fmt:formatNumber pattern="#,###" value="${coinList.coinPay}" />원</td>
