	            ...
	            <div class="second">
	               ...
	               <div class="customerNnm-form">
					...
					<div class="customerGender-form">
	                	<label class="male"><input type="radio" name="customerGender" value="남성">남</label>
	                	<label class="female"><input type="radio" name="customerGender" value="여성">여</label>
	                	<label for="">성별</label>
	            	</div>
	            </div>
