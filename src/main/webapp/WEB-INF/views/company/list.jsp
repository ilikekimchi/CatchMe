...
<body>
	...
	<div class="side-bar">
		...
		<nav class="side-menu">
			...
			<ul>
				<li><a href="/company/list"><i class="fas fa-home"></i>기업회원 홈</a></li>
			...
			<div class="req-list">
				<ul>
					<li><p>닉네임</p>
						...
						<p>직급</p>
						<p>학력</p>
						<a href="#"><i class="fas fa-angle-double-right"></i></a></li>
					<li><p>닉네임</p>
						<p>나이</p>
						<p>직급</p>
						<p>학력</p>
