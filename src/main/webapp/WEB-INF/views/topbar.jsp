...
<body>
	...
	<div class="top-bar">
		...
		<div class="con">
			...
			<nav class="menu-box-1">
				<ul class="row flex flex-ai-c">
					...
					<li class="cell my-r"><a href="/customerNews">이직뉴스</a></li>
					<li class="cell my-r"><a href="/companyNews">기업뉴스</a></li>
					<li class="search-box">
		...
		<div class="member">
			...
			<a class="go-mypage"> <span class="mypage-img"></span> <c:if
					test="${sessionScope.customer == null && sessionScope.company == null}">
					<span class="name">로그인해주세요</span>
				</c:if> <c:if
					test="${sessionScope.customer != null && sessionScope.company == null}">
					<span class="name customer-name">${sessionScope.customer.customerNnm}</span>
				</c:if> <c:if
					test="${sessionScope.customer == null && sessionScope.company != null}">
					<span class="name customer-name">${sessionScope.company.companyName}</span>
				</c:if>
	...
	<div class="login-modal">
		<c:if
			...
			<div class="social">
				<a class="google_btn" href="resources/html/google.html">
					<div class="google"></div>
				</a><a href="https://kauth.kakao.com/oauth/authorize?client_id=3c5da69fe95e1794f127087d909f8e24&redirect_uri=http://localhost:8090/auth/kakao/callback&response_type=code">
					<div class="kakao"></div>
				</a> <a href="naverLogin">
					<div class="naver"></div>
				</a>
		...
		<c:if
			...
			<a href="/mypage" class="mypage in"> <span class="mypage-icon"></span>
				<div>마이페이지</div>
			</a>
			<a href="" class="resume in"> <span class="career-icon"></span>
				<div>내 이력서</div>
			</a>
		...
		<c:if
			...
			<a href="/pay/cart" class="resume in"> <span class="career-icon"></span>
				<div>코인충전소</div>
			</a>
			<a href="/logout" class="logout in"> <span class="logout-icon"></span>
				<div>로그아웃</div>
